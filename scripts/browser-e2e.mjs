...
console.log(JSON.stringify({ desktop, mobile, desktopDraw, mobileDraw, artifacts, browserErrors: logs.pageErrors.length, failedRequests: logs.failedRequests.length }, null, 2)); await browser.close();
